...
const struct ShaderParameters {
	...
	const bool lighting : 1; //contain normal vector
};
...
const static ShaderParameters DefaultShader2T = { vs,fs,true,true,false};
const static ShaderParameters Shader2TL = { TL_vs,TL_fs,true,true,true };
