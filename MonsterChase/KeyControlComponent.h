...
public:
	...
	KeyControlCompoenent(GStar::TransformComponent* transform, float movespeed) :InterfaceComponent(transform),delta(GStar::Vector3(0,0,0)), speed(movespeed) { Initialize(); }
